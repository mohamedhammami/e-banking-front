...
export class AccountService {
  ...
  createContact(contact: ContactModel ) {
    ...
    return this.httpClient.post(`${this.BASE_URL}/addcontact`, contact);
  }


  Acceptecompte(detaildemandemodif: AccountModel) {
    return this.httpClient
      .put(`${this.BASE_URL}/acceptcompte/${detaildemandemodif.rib}`,detaildemandemodif)
     ;
  }
