...
@NgModule({
  ...
  declarations: [AccountCreateComponent, AccountAddaccountComponent, AccountListComponent, AccountListaccountbancaireComponent, TransactionsComponent, AddacounttitreComponent],
  entryComponents: []
})
