...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "detail", component: DetaildeamndeComponent },
...
@NgModule({
  ...
  declarations: [CreditDemandercreditComponent, ListdemandeComponent, SimulateurComponent, DetaildeamndeComponent],
  entryComponents: []
})
