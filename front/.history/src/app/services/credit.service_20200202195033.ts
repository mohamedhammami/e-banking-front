...
export class CreditService {
  ...
  Acceptedemand(id,detaildemandemodif: DemandeCredit) {
    return this.httpClient
      .put(`${this.BASE_URL}/accept/${id}`,detaildemandemodif)
      .toPromise();
  }

  refusdemande(id,detaildemandemodif: DemandeCredit) {
    return this.httpClient
      .put(`${this.BASE_URL}/refus/${id}`,detaildemandemodif)
      .toPromise();
  }
