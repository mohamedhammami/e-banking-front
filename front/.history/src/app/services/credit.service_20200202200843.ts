...
export class CreditService {
  ...
  Acceptedemand(detaildemandemodif: DemandeCredit) {
    return this.httpClient
      .put(`${this.BASE_URL}/accept/${detaildemandemodif.id}`,detaildemandemodif)
      .toPromise();
  }
  refusdemande(detaildemandemodif: DemandeCredit,id) {
    return this.httpClient
      .put(`${this.BASE_URL}/refus/${detaildemandemodif.id}`,detaildemandemodif)
      .toPromise();
  }
