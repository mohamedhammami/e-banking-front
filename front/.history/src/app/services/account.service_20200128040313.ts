...
export class AccountService {
  ...
  getAccount(id) {
    return this.httpClient.get(`${this.BASE_URL}/getcompteBancaireclient/${id}`).toPromise();
  }
  getcb(id)
  {  
    return this.httpClient.get<AccountModel[]>(' http://localhost:8080/getcompteBancaireclient');
  }
}
